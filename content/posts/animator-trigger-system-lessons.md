...
> ...I realized that it's because I set some of the variables to private when they're supposed to be public... And yeah, if you know how many hours that took me to solve, you'd be shocked.
...
- **GitHub (Recommended for Package Manager):** [https://github.com/Cherryland120/AnimationTriggerSystem](https://github.com/Cherryland120/AnimationTriggerSystem)

Alternatively, you can download the `.unitypackage` directly from my website:

- **Direct Download:** [tasguard.com/downloadables/animator_trigger_system.unitypackage](http://tasguard.com/downloadables/animator_trigger_system.unitypackage)
